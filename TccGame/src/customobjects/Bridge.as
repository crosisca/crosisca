package citrus.objects.complex.box2dstarling {
	...
	import pixelSphere.GraphicsManager;
	...
	public class Bridge extends Box2DPhysicsObject {
		...
		public var useTexture:Boolean = true;
		...
		public var segmentArt:String = "art/moving_platform_dark.png";
		...
		public function initDisplay():void {
			...
			for (var i:uint = 0; i < numSegments; ++i) {
				var segmentImage:Image = GraphicsManager.getInstance().getImageFromArtString(segmentArt);
				var image:CitrusSprite = new CitrusSprite(i.toString(), {group:2, width:_width * 2, height:_height * 2, view:segmentImage, registration:"center"});
