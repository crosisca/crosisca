package citrus.objects.complex.box2dstarling {
	...
	public class PoolPixelsphere extends Box2DPhysicsObject
	{
		/**
		...
		public var leftWall:Boolean = false;
		
		/**
		 *build the right wall?
		 */	
		[Inspectable(defaultValue="true")]
		public var rightWall:Boolean = false;
		...
		[Inspectable(defaultValue="2")]
		public var angularDrag:Number=10;
		...
		public function PoolPixelsphere(name:String, params:Object=null)
		{
		...
		override public function handleBeginContact(contact:b2Contact):void
		{
			if(contact.GetFixtureA() == _fixture || contact.GetFixtureB() == _fixture)
			{
				...
				if (Box2DUtils.CollisionGetOther(this, contact).body.GetControllerList() == null) {
					...
					var body:b2Body = Box2DUtils.CollisionGetOther(this, contact).body;
					var physicsObject:Box2DPhysicsObject = Box2DPhysicsObject(Box2DUtils.CollisionGetOther(this, contact));
					
					if (!(physicsObject is Enemy || physicsObject is Hero)) {
